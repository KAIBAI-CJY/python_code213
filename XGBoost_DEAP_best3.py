...
# 3. 定义最优超参数
# ==========================
best_params = {'n_estimators': 100, 'max_depth': 10, 'learning_rate': 0.2, 'subsample': 1.0, 'colsample_bytree': 0.7741537145878964}
...
# 保存结果
results_df.to_csv("xgboost_results3.csv", index=False)
print("\n✅ 包含训练集、测试集真实值与预测值的结果已保存到文件：xgboost_results3.csv")
