...
clf = AutoTabPFNRegressor(max_time = 120,device="cuda")  # 若支持 random_state 可加入 random_state=SEED
...
results_df.to_csv("TabPFN_results_post3_600.csv", index=False)
print("\n预测结果和最优超参数已保存到文件：TabPFN_results_post3_600.csv")